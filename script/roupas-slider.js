...
// Adiciona ouvintes de evento para os botões de seta para rolar o carrossel para a esquerda e para a direita
...
const dragging = (e) => {
    if(!isDragging) return; // se isDragging for false retorna daqui
...
const autoPlay = () => {
    if(window.innerWidth < 300 || !isAutoPlay) return; // Retorna se a janela for menor que 800 ou isAutoPlay for false
